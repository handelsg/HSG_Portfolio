      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Desenvolvedor Full Stack comprometido em entregar soluções eficientes e inovadoras, 
              combinando tecnologia e usabilidade em aplicações robustas e escaláveis.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © {new Date().getFullYear()} Handel Santana Gomes. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
